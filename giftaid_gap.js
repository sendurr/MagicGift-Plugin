...
a.innerHTML = 
	...
	'<button  id="gift_aid_submit" class="clearfix" style="background-color:rgb(200, 49, 30); border-radius: 8px; font-size: 16px; color:white;"> Add to Gift Aid'+
	'</button>';

parent = document.getElementById("productNameText");
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementById("product_image_bg").getElementsByTagName('img');
	...
	// get the product descriptions
		elements = document.getElementById("tabWindow");
	...
	// get the product title
		...
		elements = document.getElementById("productNameText");
	...
	// get the product price
		...
		elements = document.getElementsByClassName("salePrice")[0];
		if((typeof elements === 'undefined')){
			elements = document.getElementById("priceText");
		}
	...
	function showmessage() {
		...
		'<div class="alert alert-success alert-dismissable">'+
         ...
         '</div>';
         // e.appendTo("#navbar");
         div=document.getElementById("responsiveUniversalBar");
         div.appendChild(e);
