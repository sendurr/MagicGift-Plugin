...
a.innerHTML = 
	...
	'<button  id="gift_aid_submit" class="pdp-addtobag"> Add to Gift Aid'+
	'</button>';

parent = document.getElementsByClassName("pdp-main-container clearfix")[0];
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementsByClassName("pdp_ver_carousel")[0].getElementsByTagName('li');
	...
	// get the product descriptions
		elements = document.getElementsByClassName("accordion-segment-content")[0];
	...
	// get the product title
		...
		elements = document.getElementsByClassName("pdp-product-title")[0];
	...
	// get the product price
		...
		elements = document.getElementsByClassName("main-price red-font")[0];
	...
	function showmessage() {
		...
		'<div class="alert alert-success alert-dismissable">'+
         ...
         '</div>';
         // e.appendTo("#navbar");
         div=document.getElementsByClassName("pdp-back")[0];
         div.appendChild(e);
