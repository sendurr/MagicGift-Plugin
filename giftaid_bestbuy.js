...
a.innerHTML = 
	...
	'<button  id="gift_aid_submit" class="btn btn-transaction  bby-icon"> Add to Gift Aid'+
	'</button>';

parent = document.getElementById("sku-title");
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementsByClassName("carousel-indicators")[0].getElementsByTagName('li');
	...
	// get the product descriptions
		elements = document.getElementsByClassName("overview-features col6")[0];
		if (typeof elements === 'undefined'){
			console.log("No description");
			elements = document.getElementById("features");
		}
	...
	// get the product title
		...
		elements = document.getElementById("sku-title");
	...
	// get the product price
		...
		elements = document.getElementsByClassName("item-price")[0];
