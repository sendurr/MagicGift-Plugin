...
a.innerHTML = 
	...
	'<button  id="gift_aid_submit" class="addToCart_btn dynamic_btn c" style="background-color:rgb(249, 99, 2); border-radius: 8px; font-size: 16px; color:white;"> Add to Gift Aid'+
	'</button>';

parent = document.getElementsByClassName("product_titleInfo")[0];
//console.log(parent.innerHTML);
child_elements = parent.childNodes;
child = child_elements[2]
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementsByClassName("slider_window")[0].getElementsByTagName('div');
		...
		for(i=0;i<elements.length;i++){
			...
			if (temp.endsWith('jpg')){
				temp = temp.replace('http://www.homedepot.com/catalog/productImages/65','http://www.homedepot.com/catalog/productImages/400');
				temp = temp.replace('65.jpg','400.jpg');
	...
	// get the product descriptions
		elements = document.getElementById("product-description-traditional");
		if (typeof elements === 'undefined'){
			console.log("No description");
			elements = document.getElementsByClassName("main_description alpha omega col-1-1")[0];
		}
	...
	// get the product title
		...
		elements = document.getElementsByClassName("product_title")[0];
	...
	// get the product price
		...
		elements = document.getElementsByClassName("pReg")[0];
	...
	function showmessage() {
		...
		'<div class="alert alert-success alert-dismissable">'+
         ...
         '</div>';
         // e.appendTo("#navbar");
         div=document.getElementById("breadcrumb");
         div.appendChild(e);
