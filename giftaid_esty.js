...
a.innerHTML = 
	...
	'<button class="btn-transaction" id="gift_aid_submit" width =100% > Add to Gift Aid'+
	'</button>';

parent = document.getElementById("listing-page-cart-inner");
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementById("image-carousel").getElementsByTagName('li');
	...
	// get the product descriptions
		elements = document.getElementById("item-overview");
	...
	// get the product title
		...
		elements = document.getElementById("listing-page-cart-inner");
		child_elemets = elements.childNodes;
		//console.log(elements);
		title=child_elemets[1].textContent;
		title=title.trim();
		title = title.replace(',',' ');
	...
	// get the product price
		...
		elements = document.getElementById("listing-price");
	...
	function showmessage() {
		...
		'<div class="alert alert-success alert-dismissable">'+
         ...
         '</div>';
         // e.appendTo("#navbar");
         div=document.getElementById("gnav-header");
         div.appendChild(e);
