...
a.innerHTML = 
	...
	'<button  id="gift_aid_submit" class="js-ss-click js-atc js-track-event full_width uppercase " style="background-color:rgb(102, 51, 102); border-radius: 8px; font-size: 16px; color:white;"> Add to Gift Aid'+
	'</button>';

parent = document.getElementsByClassName("product__nova__top__right__main")[0];
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementsByClassName("ProductDetailImagesThumbnails-content js-carousel-content")[0].getElementsByTagName('div');
		elements =elements[0].getElementsByTagName('img');
		//console.log(elements[0].innerHTML);
		for(i=0;i<elements.length;i++){
			src_elements = elements[i].getAttribute("src");
			temp = src_elements.replace('/42/','/50/');
	...
	// get the product title
		...
		elements = document.getElementsByClassName("product__nova__top__right__main")[0];
	...
	// get the product price
		...
		elements = document.getElementsByClassName("product_price_wrap js-get-price-width")[0];
		if((typeof elements === 'undefined')){
			elements = document.getElementsByClassName("product_price emphasis")[0];
		}
	...
	function showmessage() {
		...
		'<div class="alert alert-success alert-dismissable">'+
         ...
         '</div>';
         // e.appendTo("#navbar");
         div=document.getElementById("hd");
         div.appendChild(e);
