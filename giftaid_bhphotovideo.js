...
a.innerHTML = 
	...
	'<button  id="gift_aid_submit" class="atc-btn atcImage blueBtn pill-shaped-button fs26 cursor-pointer one-line borderBox " style="background-color:rgb(10, 146, 202); border-radius: 8px; font-size: 16px; color:white;">Add to Gift Aid </button>';

parent = document.getElementsByClassName("pProductNameContainer")[0];
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementsByClassName("image-thumbs js-imageThumbs js-close");
		if (typeof elements[0] === 'undefined'){
			console.log('No additional images - assigned with mainimageurl');
		}
		else{
			elements  = document.getElementsByClassName("image-thumbs js-imageThumbs js-close")[0].getElementsByTagName('a');
		}
		...
		for(i=0;i<elements.length;i++){
			...
			temp = temp.replace('thumbnails','images500x500');
			temp = temp.replace('smallimages','images500x500');
		...
		if (imageurls.length == 0){
			//console.log("Entered");
			elements  = document.getElementsByClassName("main-image")[0];
			//console.log(elements.getAttribute("src"));
	...
	// get the product descriptions
		elements = document.getElementsByClassName("js-productHighlights product-highlights c28 fs14 js-close")[0];
		if (typeof elements === 'undefined'){
			console.log("No description");
			elements = document.getElementsByClassName("ov-desc")[0];
		}
	...
	// get the product title
		...
		elements = document.getElementsByClassName("pProductName bold c31")[0];
	...
	// get the product price
		...
		elements = document.getElementsByClassName("ypYouPay c32 right fs24 OpenSans-600-normal")[0];
	...
	function showmessage() {
		...
		'<div class="alert alert-success alert-dismissable">'+
         ...
         '</div>';
         // e.appendTo("#navbar");
         div=document.getElementById("tHeader");
         div.appendChild(e);
