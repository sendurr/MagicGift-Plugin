...
a.innerHTML = 
	...
	'<button style="background-color:red; border-radius: 8px; font-size: 16px; color:white;" id="gift_aid_submit" width =100% > Add to Gift Aid'+
	'</button>';

parent = document.getElementsByClassName("product-name item")[0];
...
button.addEventListener ("click", function() {
 	...
 	// get the main product image & additional product images
		...
		elements  = document.getElementById("carouselContainer");
		if (typeof elements === 'undefined'){
			//continue;
		}
		else{
			elements = document.getElementById("carouselContainer").getElementsByTagName('li');
		}

		//console.log("The image link " + elements[1].innerHTML);
	...
	// get the product descriptions
		elements = document.getElementsByClassName("details-copy")[0];
		if (typeof elements === 'undefined'){
			console.log("No description");
			elements = document.getElementsByClassName("section show-dotted-border")[0];
		}
	...
	// get the product title
		...
		elements = document.getElementsByClassName("product-name item")[0];
	...
	// get the product price
		...
		elements = document.getElementsByClassName("offerPrice")[0];
	...
	function showmessage() {
		...
		'<div class="alert alert-success alert-dismissable">'+
         ...
         '</div>';
         // e.appendTo("#navbar");
         div=document.getElementsByClassName("shipping_ribbon")[0];
         div.appendChild(e);
